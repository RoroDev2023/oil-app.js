            ...
            <div class="py-16 px-4 mx-auto max-w-screen-xl sm:py-24 lg:px-6">
                ...
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 mt-28 mb-8">
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">•  Oil and Gas</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">•  Global Reach</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">•  Variety of Products</h3>
