...
function Contact() {
  return (
    <>  
        <section class="bg-white dark:bg-gray-900 bg-[url('https://wallpaperaccess.com/full/505837.jpg')] bg-cover">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md ">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white  font-mono">Contact Us 👇🏻</h2>
