        ...
        <section className="relative bg-center bg-no-repeat bg-cover bg-gray-600 bg-blend-multiply h-[93vh]" style={{backgroundImage: `url(${backgroundImage})`}}>
          <div className="px-4 mx-auto max-w-screen-xl h-full text-left py-32">
            <div className='max-w-2xl'>
                ...
                <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white mt-4">Get back to <span className='decoration-solid underline underline-offset-[11px] decoration-green-600'>growth </span> with our <span class="text-violet-600 dark:text-red-500">#1 Trading</span> services.</h1>
