...
function Trading() {
    return (
        <section className="relative bg-center bg-no-repeat bg-cover bg-gray-500 bg-blend-multiply h-[93vh]" style={{backgroundImage: `url(${backgroundImage})`}}>
          <div className="px-4 mx-auto max-w-screen-xl h-full text-left py-32">
            <div className='max-w-2xl'>
                ...
                <h1 class="mb-4 text-4xl font-bold leading-none tracking-tight md:text-5xl lg:text-6xl text-white mt-12">Get back to <span className='decoration-solid underline underline-offset-[11px] decoration-red-600 font-normal'>growth </span> with our <span class="text-yellow-400 font-normal">#1 Trading</span> services.</h1>
