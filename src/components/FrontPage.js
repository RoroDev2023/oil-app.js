      ...
      <div className="px-4 mx-auto max-w-screen-xl h-full text-left py-32">
        ...
        <div className='flex flex-row rounded-sm mt-48 hidden md:flex'>
          <div className="flex flex-col mr-8">
            <Link to="/trading" className="bg-[#1E90FF] rounded-full py-1 px-2 cursor-pointer items-end">
          ...
          <div className="flex flex-col items-center">
            <Link to="/about" className="bg-[#1E90FF] rounded-full py-1 px-2 cursor-pointer">
